    ...
    return (
        <Fragment>
            ...
            <Text>
                ...
                In what situations and with which types of parties do we share information?
                We do not share your information with the exception of providing it to the relevant third-party service providers as mentioned above.
                ...
                Usage Data. Log and usage data is service-related, diagnostic, usage, and performance information our servers automatically collect when you access or use our Website and which we record in log files. Depending on how you interact with us, this log data may include browser type and settings and information about your activity on the Website (such as the date/time stamps associated with your usage, pages and files viewed, searches, and other actions you take such as which features you use), device event information (such as system activity, error reports (sometimes called "crash dumps"), and hardware settings).
                User name and email address as an exception to the table below when subscribing to our platform, creating what we call a Profile.
                CATEGORY: EXAMPLES: COLLECTED:
                1. Identifiers: Contact details, such as a real name, alias, postal address, telephone or mobile contact number, unique personal identifier, online identifier, email address: YES

                2. Personal information categories listed in the EU GDPR provisions: Name, contact information, education, employment, employment history, and financial information: NO
                3. Protected classification characteristics under the EU GDPR provisions: Contact details, such as a real name, alias, postal address, telephone or mobile contact number, unique personal identifier, online identifier, email address: NO
                4. Biometric information: Contact details, such as a real name, alias, postal address, telephone or mobile contact number, unique personal identifier, online identifier, email address: NO
                5. Internet or other similar network activity: Contact details, such as a real name, alias, postal address, telephone or mobile contact number, unique personal identifier, online identifier, email address: YES
                6. Geolocation data: Contact details, such as a real name, alias, postal address, telephone or mobile contact number, unique personal identifier, online identifier, email address: YES
                7. Audio, electronic, visual, thermal, olfactory, or similar information: Contact details, such as a real name, alias, postal address, telephone or mobile contact number, unique personal identifier, online identifier, email address: NO
                8. Message content and correspondence: Contact details, such as a real name, alias, postal address, telephone or mobile contact number, unique personal identifier, online identifier, email address: YES

                2. HOW DO WE PROCESS YOUR INFORMATION?
                In Short: We process your information using third-party data processors to provide, improve, and administer our Services, communicate with you, for security and fraud prevention, and to comply with the law. We may also process your information for other purposes with your consent.
