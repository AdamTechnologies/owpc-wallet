    ...
    return (
        <Fragment>
            ...
            <Text>
                ...
                1. Identifiers	Contact details, such as real name, alias, postal address, telephone or mobile contact number, unique personal identifier, online identifier, email address	YES
                ...
                3. Protected classification characteristics under the EU GDPR provisions	Contact details, such as real name, alias, postal address, telephone or mobile contact number, unique personal identifier, online identifier, email address	NO
                4. Biometric information	Contact details, such as real name, alias, postal address, telephone or mobile contact number, unique personal identifier, online identifier, email address	NO
                5. Internet or other similar network activity	Contact details, such as real name, alias, postal address, telephone or mobile contact number, unique personal identifier, online identifier, email address	YES
                6. Geolocation data	Contact details, such as real name, alias, postal address, telephone or mobile contact number, unique personal identifier, online identifier, email address	YES
                7. Audio, electronic, visual, thermal, olfactory, or similar information	Contact details, such as real name, alias, postal address, telephone or mobile contact number, unique personal identifier, online identifier, email address	NO
                8. Message content and correspondence	Contact details, such as real name, alias, postal address, telephone or mobile contact number, unique personal identifier, online identifier, email address	YES

                2. HOW DO WE PROCESS YOUR INFORMATION?
                In Short: We process your information using third party data processors to provide, improve, and administer our Services, communicate with you, for security and fraud prevention, and to comply with law. We may also process your information for other purposes with your consent.
